...
public class Principal extends JFrame implements ActionListener{
  ...
  // Crea un objeto de tipo Bienvenida para obtener el texto que ingresó el usuario.
  public Principal(){
    setLayout(null);
    ...
    miElCreador = new JMenuItem("Javitoooo");
  ...
  // El método actionPerformed define el comportamiento del programa según qué menuItem se seleccione
  public void actionPerformed(ActionEvent e){
    if(e.getSource() == miCalculo){
      ...
      if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
        ...
        // Los tres if que siguen, son para realizar los cálculos correspondientes según Departamento y Antigüedad.
    ...
    if(e.getSource() == miElCreador){
       ...
       JOptionPane.showMessageDialog(null, "Desarrollado por Javitooooo");
